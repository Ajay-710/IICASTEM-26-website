...
import { LucideIcon, Home, Info, Users, FileText, PenTool, Phone } from "lucide-react"
...
const navItems: NavItem[] = [
    ...
    { name: "About Conference", url: "#about", icon: Info },
    { name: "Committees", url: "#committees", icon: Users },
    { name: "Call for Papers", url: "#topics", icon: FileText },
    { name: "Authors", url: "#authors", icon: PenTool },
